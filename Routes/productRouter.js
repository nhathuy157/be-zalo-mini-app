...
productRouter.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const categoryFilter = req.query.type ? { category: req.query.type } : {};
    ...
    const product = await Product.find({ filterCondition })
      .limit(pageSize)
...
productRouter.post(
  ...
  admin,
  asyncHandler(async (req, res) => {
    const { category, productName, image, description } = req.body;
